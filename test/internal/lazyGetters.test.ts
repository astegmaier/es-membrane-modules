...
(function () {
  ...
  describe("Internal API:  Defining a lazy getter", function () {
    ...
    it("and then invoking the lazy getter stores the first available property value on the shadow", function () {
      parts.handlers.dry.defineLazyGetter(wetDocument, shadow, "nodeType");
    ...
    it("and then setting the named value on the shadow overrides the lazy getter but does not propagate the property to the underlying target", function () {
      parts.handlers.dry.defineLazyGetter(wetDocument, shadow, "nodeType");
      shadow.nodeType = 15;
    ...
    it("and then sealing the dry value locks in the properties of the shadow target", function () {
      parts.handlers.dry.defineLazyGetter(wetDocument, shadow, "nodeType");
    ...
    it("and then freezing the dry value locks in the properties of the shadow target", function () {
      parts.handlers.dry.defineLazyGetter(wetDocument, shadow, "nodeType");
