  ...
  describe(".prototype.addListener", function () {
    ...
    it("for a function's prototype", function () {
      ...
      // This is about using "value" versus "prototype" in the second argument.
      {
        ...
        parts.distortions.addListener(parts.wet.C.prototype, "value", parts.config);
    ...
    it("for an iterable list of values", function () {
      ...
      parts.distortions.addListener([parts.wet.A, B, C, D], "iterable", parts.config);
      parts.bindDry();
      parts.updateKeys();
    ...
    it("for a filterable list of values", function () {
      ...
      parts.distortions.addListener(filter, "filter", parts.config);
      parts.bindDry();
      parts.updateKeys();
