...
describe("Reflect.deleteProperty() in non-proxy operations returns", function () {
  ...
  it("true when the existing property descriptor says the property is configurable", function () {
  ...
  it("false when the existing property descriptor says the property is configurable", function () {
    Reflect.defineProperty(inner, "prop", {
      value: 2,
      writable: true,
      enumerable: true,
  ...
  it("true when the object is non-extensible", function () {
    Reflect.defineProperty(inner, "prop", {
      value: 2,
      writable: true,
      enumerable: true,
...
describe("Reflect.deleteProperty() in proxy operations returns", function () {
  ...
  it("true when the proxy is non-extensible", function () {
    Reflect.defineProperty(inner, "prop", {
      value: 2,
      writable: true,
      enumerable: true,
