describe("Promises", function () {
  ...
  it("may be resolved from Proxy.getOwnPropertyDescriptor synchronously", function (done) {
    const handler = {
  ...
  it("may be resolved from Proxy.get synchronously", function (done) {
    const handler = {
  ...
  it("may be rejected from Proxy.getOwnPropertyDescriptor synchronously", function (done) {
    const handler = {
      getOwnPropertyDescriptor: function (target, propertyName) {
        const rv = {
          value: builtPromise,
  ...
  it("may be rejected from Proxy.get synchronously", function (done) {
    const handler = {
      get: function (/*target, propertyName, receiver*/) {
        return builtPromise;
      }
