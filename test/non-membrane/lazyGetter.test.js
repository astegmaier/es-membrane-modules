describe("A lazy getter can define a property before it is needed", function () {
  "use strict";
  ...
  describe("on an ordinary object", function () {
    ...
    it("when the property descriptor is a DataDescriptor", function () {
    ...
    it("when the property descriptor is an AccessorDescriptor", function () {
  ...
  it("on a set of cyclic references objects about to be sealed", function () {
    ...
    const pHandler = {
      preventExtensions: function (shadowTarget) {
        ...
        keys.forEach(function (propName) {
          defineCyclicLazyGetter(target, shadowTarget, propName);
    ...
    function defineCyclicLazyGetter(realTarget, shadowTarget, propName) {
      ...
      const lazyDesc = {
        ...
        enumerable: Reflect.getOwnPropertyDescriptor(realTarget, propName).enumerable,
