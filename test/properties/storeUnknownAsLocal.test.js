...
describe("Storing unknown properties locally", function () {
  ...
  function addUnknownPropertySpecs() {
    it("defineProperty stores a value on the dry graph only", function () {
      let x = { isExtra: true };
    ...
    it("defineProperty replaces a value on the dry graph only", function () {
    ...
    it("defineProperty preserves the order of inserted values", function () {
    ...
    it("defineProperty will not mask existing properties of the wet object graph", function () {
      const isWetExtensible = Reflect.isExtensible(wetRoot);
      const isDryExtensible = Reflect.isExtensible(dryRoot);
    ...
    it("defineProperty works when the property is not configurable", function () {
      const isDryExtensible = Reflect.isExtensible(dryRoot);
    ...
    describe("defineProperty works correctly with previously defined accessor descriptors", function () {
      ...
      it("on the dry object graph", function () {
        ...
        expect(Reflect.getOwnPropertyDescriptor(wetRoot, "localProp")).toBe(undefined);
     ...
     */
    it("defineProperty does nothing when the proxy is not extensible", function () {
    ...
    it("defineProperty called on the wet graph for the same name does not override the dry graph", function () {
      const isDryExtensible = Reflect.isExtensible(dryRoot);
    ...
    it("defineProperty called on the damp graph for the same name does not override the dry graph", function () {
      const isDryExtensible = Reflect.isExtensible(dryRoot);
      Reflect.defineProperty(dryRoot, "firstExtra", {
        value: 1,
        writable: true,
    ...
    it("deleteProperty on the dry graph deletes from both the dry graph and the wet graph", function () {
    ...
    it("deleteProperty called on the wet graph does not override the dry graph", function () {
      const isWetExtensible = Reflect.isExtensible(wetRoot);
      const isDryExtensible = Reflect.isExtensible(dryRoot);
      Reflect.defineProperty(dryRoot, "firstExtra", {
        value: 1,
    ...
    it("deleteProperty called on the damp graph does not override the dry graph", function () {
    ...
    describe("deleteProperty works correctly with previously defined accessor descriptors", function () {
      it("on the wet object graph", function () {
        var local = "one";
        // This isn't the test.
        ...
        expect(Reflect.getOwnPropertyDescriptor(dryRoot, "localProp")).toBe(undefined);
        expect(Reflect.getOwnPropertyDescriptor(wetRoot, "localProp")).toBe(undefined);
      });
    ...
    describe("set stores unknown properties locally on the dry graph, unwrapped", function () {
      ...
      it("when the object has a direct data descriptor with that name", function () {
        const isDryExtensible = Reflect.isExtensible(dryRoot);
        Reflect.defineProperty(dryRoot, "extra", {
          value: { isExtra: 1 },
          writable: true,
      ...
      it("when the object has a direct accessor descriptor with that name", function () {
        const isDryExtensible = Reflect.isExtensible(dryRoot);
        let extraValue = 1;
        Reflect.defineProperty(dryRoot, "extra", {
          get: function () {
      ...
      it("when the object has a locally inherited data descriptor with that name", function () {
        const isDryExtensible = Reflect.isExtensible(dryRoot);
      ...
      it("when the object has a proxied inherited data descriptor with that name", function () {
        const isDryExtensible = Reflect.isExtensible(dryRoot);
        let y = { isExtra: 1 };
      ...
      it("when the object has a locally inherited accessor descriptor with that name", function () {
        const isDryExtensible = Reflect.isExtensible(dryRoot);
        let extraValue = 1;
        Reflect.defineProperty(parts.dry.Node.prototype, "extra", {
          get: function () {
      ...
      it("when the object has a proxied inherited accessor descriptor with that name", function () {
        const isDryExtensible = Reflect.isExtensible(dryRoot);
        let extraValue = 1;
        Reflect.defineProperty(parts.wet.Node.prototype, "extra", {
          get: function () {
    ...
    it("deleteProperty followed by .defineProperty is consistent with new properties", function () {
      const isDryExtensible = Reflect.isExtensible(dryRoot);
    ...
    it("deleteProperty followed by .defineProperty is consistent with predefined properties", function () {
  ...
  function specsWithSealAndFreezeOptions() {
    describe("on unsealed objects, ObjectGraphHandler(dry).", addUnknownPropertySpecs);
  ...
  describe("when required by both the wet and the dry object graphs, ", function () {
    beforeEach(function () {
      parts.handlers.wet.ensureMapping(parts.wet.Node.prototype);
      membrane.modifyRules.storeUnknownAsLocal("wet", parts.wet.Node.prototype);
      membrane.modifyRules.storeUnknownAsLocal("dry", parts.dry.Node.prototype);
  ...
  it("and then applying a seal() operation on the proxy still works", function () {
  ...
  it("and then applying a freeze() operation on the proxy still works", function () {
    /* This is an order-of-operations test:  unlike the above tests, which
     * may seal the dryRoot before the defineProperty operation, this test
     * sets the property and then seals the dryRoot.
     */
