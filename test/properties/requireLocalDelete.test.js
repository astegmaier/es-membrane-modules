...
describe("Deleting properties locally", function () {
  ...
  function requireLocalDeleteSpecs() {
    ...
    it("deleteProperty() hides a property stored first on the wet graph", function () {
      const isExtensible = Reflect.isExtensible(wetRoot);
    ...
    it("deleteProperty() on the dry graph, followed by defineProperty() on the wet graph, does not expose the property again", function () {
      const isExtensible = Reflect.isExtensible(wetRoot);
      Reflect.defineProperty(dryRoot, "extra", {
        value: 2,
        writable: true,
    ...
    it("deleteProperty() on the dry graph, followed by defineProperty() on the damp graph, does not expose the property again", function () {
      const isExtensible = Reflect.isExtensible(wetRoot);
      Reflect.defineProperty(dryRoot, "extra", {
        value: 2,
        writable: true,
    ...
    it("deleteProperty() on the dry graph, followed by defineProperty() on the dry graph, re-exposes the property", function () {
      const isExtensible = Reflect.isExtensible(wetRoot);
      Reflect.defineProperty(dryRoot, "extra", {
        value: 2,
        writable: true,
    ...
    it("deleteProperty() is not impacted by .preventExtensions() on the dry graph", function () {
      const isExtensible = Reflect.isExtensible(wetRoot);
      Reflect.defineProperty(dryRoot, "extra", {
        value: 1,
        writable: true,
    ...
    it("deleteProperty() is not impacted by .preventExtensions() on the wet graph", function () {
      const isExtensible = Reflect.isExtensible(wetRoot);
      Reflect.defineProperty(dryRoot, "extra", {
        value: 1,
        writable: true,
    ...
    it("deleteProperty() is not impacted by .preventExtensions() on the damp graph", function () {
      const isExtensible = Reflect.isExtensible(wetRoot);
      Reflect.defineProperty(dryRoot, "extra", {
        value: 1,
        writable: true,
  ...
  function specsWithSealAndFreezeOptions() {
    describe("on unsealed objects, ObjectGraphHandler(dry).", requireLocalDeleteSpecs);
  ...
  describe("when required by the damp object graph, ObjectGraphHandler(dry).", function () {
    ...
    it("deleteProperty() removes a configurable property", function () {
      Reflect.defineProperty(dryRoot, "extra", {
        value: 1,
        writable: true,
        enumerable: false,
    ...
    it("deleteProperty() does not hide a property stored first on the wet graph", function () {
      Reflect.defineProperty(wetRoot, "extra", {
        value: 1,
        writable: true,
        enumerable: false,
    ...
    it("deleteProperty() on the dry graph, followed by defineProperty() on the wet graph, exposes the property again", function () {
      Reflect.defineProperty(dryRoot, "extra", {
        value: 2,
        writable: true,
        enumerable: false,
    ...
    it("deleteProperty() on the dry graph, followed by defineProperty() on the damp graph, exposes the property again", function () {
      Reflect.defineProperty(dryRoot, "extra", {
        value: 2,
        writable: true,
        enumerable: false,
    ...
    it("deleteProperty() on the dry graph, followed by defineProperty() on the dry graph, exposes the property again", function () {
      Reflect.defineProperty(dryRoot, "extra", {
        value: 2,
        writable: true,
        enumerable: false,
