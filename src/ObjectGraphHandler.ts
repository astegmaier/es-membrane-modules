...
export function ObjectGraphHandler(membrane, fieldName) {
  ...
  let boundMethods = {};
  ["apply", "construct"].forEach(function (key) {
    Reflect.defineProperty(boundMethods, key, new NWNCDataDescriptor(this[key].bind(this), false));
  }, this);
...
}
{
  ...
  ObjectGraphHandler.prototype = Object.seal(
    /** @type {IObjectGraphHandlerPrototype} */ ({
    ...
    */
     ...
     */
      ...
      // ProxyHandler
      getOwnPropertyDescriptor: inGraphHandler(
        "getOwnPropertyDescriptor",
        function (shadowTarget, propName) {
    ...
    */
       ...
       */
      defineProperty: inGraphHandler(
        "defineProperty",
        function (shadowTarget, propName, desc, shouldBeLocal = false) {
      ...
      set: inGraphHandler("set", function (shadowTarget, propName, value, receiver) {
        ...
        if (mayLog) {
          this.membrane.logger.debug(
            "set propName: " + propName.toString(),
    ...
    */
      ...
      // ProxyHandler
      construct: inGraphHandler("construct", function (shadowTarget, argumentsList, ctorTarget) {
       ...
       * @private
       */
      notifyFunctionListeners: function (reason, trapName, target, rvOrExn, origin) {
        var listeners;
        {
